...
function headerScore() {
    const headerScoreText = document.querySelector('.scorer');
    headerScoreText.textContent = `Score: ${userScore} / ${questions.length}`;

    const higherscore = document.querySelector('.best-tn');
    higherscore.textContent = `Meilleur Score: ${highscore}`;
}
...
function showResultBox() {
    ...
    scoreText.textContent = `Votre score est ${userScore} sur ${questions.length}`;

    const cercleProgress = document.querySelector('.cercle-progress');
